...
const projects = [
  ...
  },
  {
    ...
    description:
      "Rediseño orientado a conversión que mejoró la claridad de catálogo y el flujo de compra en móvil.",
  ...
  },
  {
    ...
    description:
      "Landing premium para captar leads cualificados con storytelling visual y llamadas a la acción estratégicas.",
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {projects.map((proj, i) => (
            ...
            >
              <div className="h-56 bg-cover bg-center transition duration-300 group-hover:scale-105" style={{ backgroundImage: `url(${proj.image})` }} />
